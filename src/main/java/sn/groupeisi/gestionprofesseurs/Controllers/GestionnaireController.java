...
public class GestionnaireController  implements Initializable {
    ...
    void btnCours(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/sn/groupeisi/gestionprofesseurs/pages/GestionCoursG.fxml"));
    ...
    void btnProfesseurs(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/sn/groupeisi/gestionprofesseurs/pages/GestionProfesseursG.fxml"));
            Parent fxml = loader.load();
            // Charge le fichier FXML correctement
    ...
    void  btnSalle(ActionEvent event){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/sn/groupeisi/gestionprofesseurs/pages/GestionSallesG.fxml"));
            Parent fxml = loader.load();
            // Charge le fichier FXML correctement
    ...
    void btnEmergements(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/sn/groupeisi/gestionprofesseurs/pages/GestionEmergementsG.fxml"));
            Parent fxml = loader.load();
            // Charge le fichier FXML correctement
